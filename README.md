...
This repository was forked from the AI Guy on YouTube. There are minor changes That make it work with a USB Relay to control machines based on what is detected.
