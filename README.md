...
The JRS_DetectorSorter.py script is the star of the show.
Use this script to collect training data and also to classify images and trigger a relay based on the classification results.
